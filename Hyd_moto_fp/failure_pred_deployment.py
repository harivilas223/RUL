...
def model_pred(req_df):
    with open('/home/srinivas/SONA_BLW/Hyd_moto_fp/hyd_motor.pkl', "rb") as pickle_file:
        ann_model = joblib.load(pickle_file)
    x_test = req_df[['AB_HYD.MOTOR_DE_TEMP', 'AB_HYD.MOTOR_DE_VIBRATION',
                     'AB_HYD.MOTOR_NDE_TEMP', 'AB_HYD.MOTOR_NDE_VIBRATION',
                     'AB_HYD.OIL_LEVEL', 'AB_HYD.OIL_TEMP',
                     'RGH_EM_ACTIVE_CONSUMPTION', 'RGH_EM_FREQUENCY',
                     'RGH_EM_L1', 'RGH_EM_L2', 'RGH_EM_L3', 'RGH_EM_LN',
                     'RGH_EM_LN_POWER', 'RGH_EM_PF', 'RGH_EM_V1',
                     'RGH_EM_V2', 'RGH_EM_V3', 'RGH_EM_VN']]
